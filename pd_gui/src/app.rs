...
use iced::{
    button, keyboard, pane_grid, Button, Column, Command, Container, Element,
    Length, PaneGrid, Row, Subscription, Text,
};
...
use ui::colors::{PANE_ID_COLOR_FOCUSED, PANE_ID_COLOR_UNFOCUSED};
use ui::components::panes::{style, Pane};
